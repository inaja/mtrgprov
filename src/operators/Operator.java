	...
	public void reasonRDFS(boolean uploadToFuseki, String Op) 
	{
		...
		if (uploadToFuseki) {
			try {
				...
				SPARQLUtilities.uploadNewGraph(DATASET4MT, c3.getGraph_BASE_NAME(), c3.getGraph_BASE_MODEL());
				SPARQLUtilities.uploadNewGraph(DATASET4MT, c3.getGraph_INFS_NAME(), c3.getGraph_INFS_MODEL());
