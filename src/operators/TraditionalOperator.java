...
public class TraditionalOperator extends ParentOperator 
{
	...
	public void loadBothGraphsAndTheirProvs(String graphA1_source_NAME, String graphA1_source_PROV_NAME, String graphB2_source_NAME, String graphB2_source_PROV_NAME) throws IOException 
	{
		...
		Utilities.writeModelToFile(a1.getGraph_MODEL(), graphStoresLocal_URI + "/cacheStoreC/traditional/" + a1.getGraph_COPY_NAME(), "TURTLE");
		Utilities.writeModelToFile(a1.getGraph_PROV_COPY_MODEL(), graphStoresLocal_URI + "/cacheStoreC/traditional/" + a1.getGraph_PROV_COPY_NAME(), "TURTLE");
		Utilities.writeModelToFile(a1.getGraph_PROV_star_COPY_MODEL(), graphStoresLocal_URI + "/cacheStoreC/traditional/" + a1.getGraph_PROV_star_COPY_NAME(), "TURTLE");
		
		Utilities.writeModelToFile(b2.getGraph_MODEL(), graphStoresLocal_URI + "/cacheStoreC/traditional/" + b2.getGraph_COPY_NAME(), "TURTLE");
		Utilities.writeModelToFile(b2.getGraph_PROV_COPY_MODEL(), graphStoresLocal_URI + "/cacheStoreC/traditional/" + b2.getGraph_PROV_COPY_NAME(), "TURTLE");
		Utilities.writeModelToFile(b2.getGraph_PROV_star_COPY_MODEL(), graphStoresLocal_URI + "/cacheStoreC/traditional/" + b2.getGraph_PROV_star_COPY_NAME(), "TURTLE");
	}
	...
	public void initializeC (String graphC3_NAME, String graphC3_PROV_NAME) 
	{
		...
		Utilities.writeModelToFile(c3.getGraph_PROV_MODEL(), graphStoresLocal_URI + "/cacheStoreC/traditional/" + c3.getWithoutTTL_Graph_PROV_NAME()+"initialLoad.ttl", "ttl");
	}
	...
	public void createSTGraph (String graphSTA1B2_NAME) 
	{
		...
		Utilities.writeModelToFile(graphSTA1B2_MODEL, graphStoresLocal_URI + "/tempMemoryC/traditional/" + c3.getWithoutTTL_Graph_NAME()+ "_ST.ttl", "ttl");
		
		Utilities.writeModelToFile(c3.getGraph_PROV_MODEL(), graphStoresLocal_URI + "/tempMemoryC/traditional/" + c3.getWithoutTTL_Graph_PROV_NAME()+ "ST" + ".ttl", "ttl");
	}
